...
<div class="uk-container uk-container-medium uk-margin-small-top">
    <div class="uk-grid-small uk-grid-match uk-child-width-expand@s uk-text-center" hidden="" id="charts_area" uk-grid>
      <div>
          <div class="uk-card uk-card-default uk-card-body"><?php include("../charts/chart_funcionario_estado_civil.php") ?></div>
      </div>
      <div>
          <div class="uk-card uk-card-default uk-card-body"><?php include("../charts/chart_funcionario_histogram.php") ?></div>
      </div>
      <div>
    ...
    <div class="uk-grid-small uk-grid-match uk-child-width-expand@s uk-text-center" hidden="" id="charts_area" uk-grid>
      <div>
          <div class="uk-card uk-card-default uk-card-body"><?php include("../charts/chart_funcionario_salario_histogram.php") ?></div>
      </div>
      <div>
            <div class="uk-card uk-card-default uk-card-body">
              <?php
                  $sql = 'select @media as media, @desvio as desvio from dual;';
                  foreach ($dbl->query($sql) as $row) {
                    $media   = $row['media'];
                    $desvio  = $row['desvio'];
                  }
