    ...
    <div class="uk-grid uk-grid-match uk-child-width-expand@s uk-text-center">
      <div class="">
          <div class="uk-card uk-card-default uk-card-body">
              ...
              <p class="uk-margin-small"><?php echo "R$ ".number_format(($recebido_media/100), 2, ",", ""); ?></p>
              <p class="uk-text-bold uk-margin-small">Soma:</p>
              <p class="uk-margin-small"><?php echo "R$ ".number_format(($recebido_soma/100), 2, ",", ""); ?></p>
              <p class="uk-text-bold uk-margin-small">Desvio:</p>
              <p class="uk-margin-small"><?php  echo "R$ ".number_format(($recebido_desvio/100), 2, ",", "");?></p>
          </div>
      </div>
      <div class="">
          <div class="uk-card uk-card-default uk-card-body">
              ...
              <p class="uk-text-bold uk-margin-small">Media:</p>
              <p class="uk-margin-small"><?php echo "R$".number_format(($arrecadado_media/100), 2, ",", ""); ?></p>
              <p class="uk-text-bold uk-margin-small">Total:</p>
              <p class="uk-margin-small"><?php echo "R$".number_format(($arrecadado_total/100), 2, ",", ""); ?></p>
              <p class="uk-text-bold uk-margin-small">Desvio:</p>
              <p class="uk-margin-small"><?php  echo "R$".number_format(($arrecadado_desvio/100), 2, ",", "");?></p>
          </div>
      </div>
      <div class="">
          <div class="uk-card uk-card-default uk-card-body">
