...
<div class="uk-margin-medium-bottom uk-container uk-container-small custom_blue_bg custom_rounded_bottom custom_white uk-align-center uk-margin-remove-top uk-margin-remove-bottom custom_padding_5 uk-animation-fade">
  <?php if ($type == "") {?>
      ...
      <ul class="uk-pagination uk-flex-center custom_white" uk-margin>
          ...
          if ($pages >= 11) {
              if ($page <= 6) {
                  ...
                  echo '<li class="uk-disabled"><span class="custom_white">...</span></li>';
                ...
                echo '<li class="uk-disabled"><span class="custom_white">...</span></li>';
                for ($i=-3; $i < 4; $i++) {
                    $thisPage = ($page == $page+$i) ? "uk-text-bold" : "" ;
